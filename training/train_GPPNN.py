...
sys.path.append("/home/jieh/Projects/PAN_Sharp/PansharpingV/GPPNN/")
from models import get_sat_param
from models.GPPNN import InvISPNet as GPPNN
...
predir = '/home/jieh/Projects/PAN_Sharp/PansharpingV4/GPPNN/training/pretrain4'
...
save_path = os.path.join(
    '/home/jieh/Projects/PAN_Sharp/PansharpingV4/GPPNN/training/logs/%s' % (model_str),
...
for epoch in range(num_epochs):
    ...
    for i, (ms, pan, gt) in enumerate(loader['train']):
        ...
        net.zero_grad()
        optimizer.zero_grad()
        predHR, mHR = net(ms, pan, gt, rev = False)
        loss_forward = loss_fn(predHR, gt.detach())
        backHR, mHR = net(ms, pan, gt.detach(), rev=True)
        loss_backward = loss_fn(backHR, mHR.detach())*0.04
